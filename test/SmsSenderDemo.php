...
try {
    ...
    $appid = '1400038549';
    $appkey = "c16041b0f4e6f8939b2f66cf6ef4cb5b";
    $phoneNumber1 = "15224799890";
    ...
    // 普通单发
    $result = $singleSender->send(0, "86", $phoneNumber1, "测试短信", "", "");
    ...
    // 普通群发
    $phoneNumbers = array($phoneNumber1);
    ...
    $result = $multiSender->sendWithParam("86", $phoneNumber1, $templId, $params, "", "", "");
    $rsp = json_decode($result);
    echo $result;
    echo "<br>";
