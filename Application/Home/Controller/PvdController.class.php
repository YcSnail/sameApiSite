...
class PvdController extends Controller {


    public function pvd100(){
        $this->display();
    }

    public function pvd110(){
        $this->display();
    }
     ...
     * 泡沫镀膜
     */
    public function pvd120(){
        $this->display();
    }


    public function pvd200(){
        $this->display();
    }

    public function pvd210(){
        $this->display();
    }

    public function pvd220(){
        $this->display();
    }

    public function pvd230(){
        $this->display();
    }
    public function pvd240(){
        $this->display();
    }
    public function pvd250(){
        $this->display();
    }

    public function pvd260(){
        $this->display();
    }
